...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='cifar100', help='options: cifar10, cifar100, scars, aircraft, aid, nwpu')
    parser.add_argument('--dataset_name', dest='dataset', help='Alias for --dataset')
