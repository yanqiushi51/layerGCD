...
# DATASET ROOTS
# -----------------
dataset_dir = os.environ.get('DATASET_DIR', '/home/yqs/redar/data')
...
aid_root = os.environ.get('AID_ROOT', os.path.join(dataset_dir, 'AID'))
nwpu_root = os.environ.get('NWPU_ROOT', os.path.join(dataset_dir, 'NWPU-RESISC45'))
