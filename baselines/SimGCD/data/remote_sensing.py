...
AID_CLASSES = [
    ...
    'commercial', 'dense residential', 'desert', 'farmland', 'forest', 'industrial',
    'meadow', 'medium residential', 'mountain', 'park', 'parking', 'playground',
    'pond', 'port', 'railway station', 'resort', 'river', 'school',
    'sparse residential', 'square', 'stadium', 'storage tanks', 'viaduct',
]

NWPU_CLASSES = [
    'airplane', 'airport', 'baseball diamond', 'basketball court', 'beach', 'bridge',
    'chaparral', 'church', 'circular farmland', 'cloud', 'commercial area',
    'dense residential', 'desert', 'forest', 'freeway', 'golf course',
    'ground track field', 'harbor', 'industrial area', 'intersection', 'island',
    'lake', 'meadow', 'medium residential', 'mobile home park', 'mountain',
    'overpass', 'palace', 'parking lot', 'railway', 'railway station',
    'rectangular farmland', 'river', 'roundabout', 'runway', 'sea ice', 'ship',
    'snowberg', 'sparse residential', 'stadium', 'storage tank', 'tennis court',
    'terrace', 'thermal power station', 'wetland',
]

AID_CONFUSABLE_OLD = [
    'airport', 'baseball field', 'beach', 'bridge', 'commercial', 'dense residential',
    'farmland', 'forest', 'industrial', 'port', 'river', 'school', 'stadium',
    'storage tanks', 'viaduct',
]

AID_CONFUSABLE_NOVEL = [
    'bare land', 'center', 'church', 'desert', 'meadow', 'medium residential',
    'mountain', 'park', 'parking', 'playground', 'pond', 'railway station',
    'resort', 'sparse residential', 'square',
]

NWPU_CONFUSABLE_OLD = [
    'airport', 'baseball diamond', 'basketball court', 'beach', 'bridge', 'chaparral',
    'circular farmland', 'cloud', 'commercial area', 'dense residential', 'desert',
    'forest', 'freeway', 'golf course', 'harbor', 'lake', 'mountain', 'overpass',
    'railway', 'stadium', 'storage tank', 'tennis court',
]

NWPU_CONFUSABLE_NOVEL = [
    'airplane', 'church', 'ground track field', 'industrial area', 'intersection',
    'island', 'meadow', 'medium residential', 'mobile home park', 'palace',
    'parking lot', 'railway station', 'rectangular farmland', 'river', 'roundabout',
    'runway', 'sea ice', 'ship', 'snowberg', 'sparse residential', 'terrace',
