...
NWPU_CONFUSABLE_OLD = [
    ...
    'forest', 'freeway', 'golf course', 'harbor', 'industrial area', 'lake',
    'mountain', 'overpass', 'parking lot', 'railway', 'railway station',
]

NWPU_CONFUSABLE_NOVEL = [
    'airplane', 'church', 'ground track field', 'intersection',
