...
NWPU_CONFUSABLE_OLD = [
    ...
    "harbor", "lake", "mountain", "overpass", "railway", "stadium",
    "storage tank", "tennis court",
]
NWPU_CONFUSABLE_NOVEL = [
    "airplane", "church", "ground track field", "industrial area",
    "intersection", "island", "meadow", "medium residential",
    "mobile home park", "palace", "parking lot", "railway station",
    "rectangular farmland", "river", "roundabout", "runway", "sea ice",
    "ship", "snowberg", "sparse residential", "terrace",
