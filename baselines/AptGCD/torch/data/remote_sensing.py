...
AID_CLASSES = [
    "airport", "bare land", "baseball field", "beach", "bridge", "center",
    "church", "commercial", "dense residential", "desert", "farmland",
    "forest", "industrial", "meadow", "medium residential", "mountain",
    "park", "parking", "playground", "pond", "port", "railway station",
    "resort", "river", "school", "sparse residential", "square", "stadium",
...
NWPU_CLASSES = [
    ...
    "intersection", "island", "lake", "meadow", "medium residential",
    "mobile home park", "mountain", "overpass", "palace", "parking lot",
    "railway", "railway station", "rectangular farmland", "river",
    "roundabout", "runway", "sea ice", "ship", "snowberg",
    "sparse residential", "stadium", "storage tank", "tennis court",
    "terrace", "thermal power station", "wetland",
]

AID_CONFUSABLE_OLD = [
    "airport", "baseball field", "beach", "bridge", "commercial",
    "dense residential", "farmland", "forest", "industrial", "port",
    "river", "school", "stadium", "storage tanks", "viaduct",
]
AID_CONFUSABLE_NOVEL = [
    "bare land", "center", "church", "desert", "meadow",
    "medium residential", "mountain", "park", "parking", "playground",
    "pond", "railway station", "resort", "sparse residential", "square",
]

NWPU_CONFUSABLE_OLD = [
    "airport", "baseball diamond", "basketball court", "beach", "bridge",
    "chaparral", "circular farmland", "cloud", "commercial area",
    "dense residential", "desert", "forest", "freeway", "golf course",
    "harbor", "industrial area", "lake", "mountain", "overpass",
    "parking lot", "railway", "railway station",
]
NWPU_CONFUSABLE_NOVEL = [
    "airplane", "church", "ground track field", "intersection", "island",
    "meadow", "medium residential", "mobile home park", "palace",
    "rectangular farmland", "river", "roundabout", "runway", "sea ice",
    "ship", "snowberg", "sparse residential", "stadium", "storage tank",
