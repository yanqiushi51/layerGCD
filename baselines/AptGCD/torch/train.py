...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_model', type=str, default=None,
                        help='Optional full AptGCD checkpoint to initialize the prompter/backbone/projector model')
    parser.add_argument('--dataset_name', type=str, default='scars', help='options: cifar10, cifar100, imagenet_100, cub, scars, fgvc_aricraft, herbarium_19, aid, nwpu')
    ...
    if args.pretrained_model is not None:
        args.logger.info(f'Loading full model weights from {args.pretrained_model}')
