...
from data.imagenet import get_imagenet_1k_datasets, get_imagenet_100_datasets
...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    print("MergedDataset: labelled = {}, unlabelled = {}, total = {}".format(
        len(datasets["train_labelled"]),
        len(datasets["train_unlabelled"]),
        len(train_dataset),
    ))
