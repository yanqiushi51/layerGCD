...
def train(model, train_loader, test_loader, train_loader_memory, args):
    ...
    for epoch in range(args.epochs):
        ...
        if args.wandb:
            if wandb is None:
                raise ModuleNotFoundError('wandb is required when --wandb is set')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, default='scars', help='options: cifar10, cifar100, scars, aid, nwpu')
    parser.add_argument('--split_type', type=str, default='random', choices=['random', 'confusable'])
    parser.add_argument('--class_split_seed', default=0, type=int)
