...
get_dataset_funcs = {
    ...
    'aid': get_remote_sensing_datasets,
    'nwpu': get_remote_sensing_datasets
}
...
def get_datasets_with_gcdval(dataset_name, train_transform, test_transform, args):
    ...
    #
    if dataset_name in ('aid', 'nwpu'):
        raise NotImplementedError('Remote sensing datasets do not define the CMS gcdval/inductive split.')
